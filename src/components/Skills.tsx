...
export function Skills() {
  const educations = [
    {
      name: "Análise e Desenvolvimento de Sistemas | USF(Campinas)",
    },
    {
      name: "Curso de Desenvolvimento Full Stack | Dev Samurai",
    },
  ];
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            Front-end Developer | React.js | Node.js | TypeScript | JavaScript
          </p>
